...
import { 
  ...
  Trash2, Edit2,  MapPin,  ChevronRight,
  } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex font-sans overflow-hidden">
      ...
      <aside className="w-64 border-r border-slate-200 bg-white hidden md:flex flex-col z-20 relative">
        ...
        <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
          ...
          <Link to="/goals" className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-indigo-50 text-indigo-700 font-medium transition-colors">
